...
public interface IInteractionsManagement {
...
public class InteractionsManagement : IInteractionsManagement {

  private static readonly ILog Log = LogManager.GetLogger(typeof(InteractionsManagement));
  
  private readonly IInteractionsService InteractionsService;
  public InteractionsManagement(
