...
public interface IDraftsManagement {
...
public class DraftsManagement : IDraftsManagement {
  private static readonly ILog Log = LogManager.GetLogger(typeof(DraftsManagement));
  ...
  public List<Process>? DeployDraft(long idDraft){
    ...
    IDeployResourceResponse response = ZeebeService.Deploy(draft.Schema);
